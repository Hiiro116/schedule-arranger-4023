...
const GITHUB_CLIENT_ID = process.env.GITHUB_CLIENT_ID || 'e42831959043b78724e3';
const GITHUB_CLIENT_SECRET = process.env.GITHUB_CLIENT_SECRET || '818babaa8eec8a8a44932982409248f4eea7a623';
